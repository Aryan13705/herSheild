    ...
    <>
      ...
      <aside className="w-[260px] bg-[#1e293b] border-r border-slate-800 flex flex-col h-screen fixed left-0 top-0 z-50 shadow-2xl">
        ...
        <nav className="flex-1 p-4 flex flex-col gap-2 overflow-y-auto">
          <Link href="/" className="flex items-center gap-3 px-4 py-3 bg-rose-500/10 text-rose-400 rounded-xl font-medium border border-rose-500/20 transition-all hover:bg-rose-500/20">
            <Activity className="w-5 h-5" />
            Live SOS Map
          </Link>
          <Link href="/safe-zones" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 rounded-xl font-medium transition-all">
            <Map className="w-5 h-5" />
            Safe Zones
          </Link>
          <Link href="/users" className="flex items-center gap-3 px-4 py-3 text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 rounded-xl font-medium transition-all">
