...
function SOSBtn() {
  return (
    <button className="flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-white border border-red-100 text-red-500 font-medium text-sm shadow-sm hover:bg-red-50 transition-colors">
        ...
        <div className="p-4 flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors border border-gray-100">
            <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-100 shrink-0">
               <img src="https://ui-avatars.com/api/?name=Priya+Kumar&background=34A853&color=fff" alt="Profile" className="w-full h-full object-cover" />
            </div>
            <div className="overflow-hidden">
              <p className="text-sm font-semibold truncate text-gray-900">Priya Kumar</p>
